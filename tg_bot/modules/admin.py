...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    message.reply_text(tld(chat.id, "Successfully promoted {} in {}!".format(mention_html(user_member.user.id, user_member.user.first_name), html.escape(chat.title)) , parse_mode=ParseMode.MARKDOWN))
